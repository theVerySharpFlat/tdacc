...
#define SYSTEM_VECTOR_BLOCK_SIZE 512
#define STATION_VECTOR_BLOCK_SIZE SYSTEM_VECTOR_BLOCK_SIZE * 2
#define LISTING_VECTOR_BLOCK_SIZE STATION_VECTOR_BLOCK_SIZE * 10
